...
That document is the authoritative cross-component reference; the per-component sections above describe how the project-wide posture applies to **Foundation-limit-log-group-retention** specifically.
